...
public:
	...
	*/
	void InitializeSprings(size_t uiNumSprings);
	...
	*/
	void RK4Integrate(float flDeltaTime, CRopeSample** ppSampleSource, CRopeSample** ppSampleTarget);
	...
	*/
	void SetRopeSegments(size_t uiNumSegments,
	...
	*/
	void ApplyForceToSegment(const Vector& vecForce, size_t uiSegment);
	...
	*/
	bool IsValidSegmentIndex(size_t uiSegment) const;

	/**
	*	@return The origin of the given segment.
	*/
	Vector GetSegmentOrigin(size_t uiSegment) const;

	/**
	*	@return The attachment point of the given segment.
	*/
	Vector GetSegmentAttachmentPoint(size_t uiSegment) const;
	...
	*/
	Vector GetSegmentDirFromOrigin(size_t uiSegmentIndex) const;
