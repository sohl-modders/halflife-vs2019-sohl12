...
#include "CHGrunt.h"
#include "CHGruntAllyMedic.h"

#include "defaultai.h"
#include "Tasks.h"

int g_fMedicAllyQuestion;
...
// Link
//=========================================================
LINK_ENTITY_TO_CLASS(monster_human_medic_ally, CHGruntAllyMedic);

//=========================================================
// Save and Restore
//=========================================================
TYPEDESCRIPTION CHGruntAllyMedic::m_SaveData[] =
{
	DEFINE_FIELD(CHGruntAllyMedic, m_lastAttackCheck, FIELD_BOOLEAN),
	DEFINE_FIELD(CHGruntAllyMedic, m_flNextGrenadeCheck, FIELD_TIME),
	DEFINE_FIELD(CHGruntAllyMedic, m_flNextPainTime, FIELD_TIME),
	DEFINE_FIELD(CHGruntAllyMedic, m_vecTossVelocity, FIELD_VECTOR),
	DEFINE_FIELD(CHGruntAllyMedic, m_fThrowGrenade, FIELD_BOOLEAN),
	DEFINE_FIELD(CHGruntAllyMedic, m_fStanding, FIELD_BOOLEAN),
	DEFINE_FIELD(CHGruntAllyMedic, m_fFirstEncounter, FIELD_BOOLEAN),
	DEFINE_FIELD(CHGruntAllyMedic, m_cClipSize, FIELD_INTEGER),
	DEFINE_FIELD(CHGruntAllyMedic, m_iSentence, FIELD_INTEGER),
	DEFINE_FIELD(CHGruntAllyMedic, m_flFollowCheckTime, FIELD_FLOAT),
	DEFINE_FIELD(CHGruntAllyMedic, m_fFollowChecking, FIELD_BOOLEAN),
	DEFINE_FIELD(CHGruntAllyMedic, m_fFollowChecked, FIELD_BOOLEAN),
	DEFINE_FIELD(CHGruntAllyMedic, m_flLastRejectAudio, FIELD_FLOAT),
	DEFINE_FIELD(CHGruntAllyMedic, m_iBlackOrWhite, FIELD_INTEGER),
	DEFINE_FIELD(CHGruntAllyMedic, m_iHealCharge, FIELD_INTEGER),
	DEFINE_FIELD(CHGruntAllyMedic, m_fUseHealing, FIELD_BOOLEAN),
	DEFINE_FIELD(CHGruntAllyMedic, m_fHealing, FIELD_BOOLEAN),
	DEFINE_FIELD(CHGruntAllyMedic, m_flLastUseTime, FIELD_TIME),
	DEFINE_FIELD(CHGruntAllyMedic, m_hNewTargetEnt, FIELD_EHANDLE),
	DEFINE_FIELD(CHGruntAllyMedic, m_fGunHolstered, FIELD_BOOLEAN),
	DEFINE_FIELD(CHGruntAllyMedic, m_fHypoHolstered, FIELD_BOOLEAN),
	DEFINE_FIELD(CHGruntAllyMedic, m_fHealActive, FIELD_BOOLEAN),
	DEFINE_FIELD(CHGruntAllyMedic, m_iWeaponIdx, FIELD_INTEGER),
	DEFINE_FIELD(CHGruntAllyMedic, m_flLastShot, FIELD_TIME),
};

IMPLEMENT_SAVERESTORE(CHGruntAllyMedic, CSquadTalkMonster);

const char* CHGruntAllyMedic::pMedicSentences[] =
{
...
// started moving.
//=========================================================
void CHGruntAllyMedic::SpeakSentence()
{
	...
	if (FOkToSpeak())
	{
		SENTENCEG_PlayRndSz(ENT(pev), pMedicSentences[m_iSentence], 
			MEDIC_SENTENCE_VOLUME, GRUNT_ATTN, 0, m_voicePitch);
		JustSpoke();
	}
}
...
//=========================================================
void CHGruntAllyMedic::GibMonster()
{
	Vector	vecGunPos;
	Vector	vecGunAngles;
...
//=========================================================
int CHGruntAllyMedic::ISoundMask()
{
...
//=========================================================
BOOL CHGruntAllyMedic::FOkToSpeak()
{
...
//=========================================================
//=========================================================
void CHGruntAllyMedic::JustSpoke()
{
...
//=========================================================
void CHGruntAllyMedic::PrescheduleThink()
{
...
//=========================================================
BOOL CHGruntAllyMedic::FCanCheckAttacks()
{
...
// CheckMeleeAttack1
//=========================================================
BOOL CHGruntAllyMedic::CheckMeleeAttack1(float flDot, float flDist)
{
	CBaseMonster* pEnemy;
...
//=========================================================
BOOL CHGruntAllyMedic::CheckRangeAttack1(float flDot, float flDist)
{
...
// attack. 
//=========================================================
BOOL CHGruntAllyMedic::CheckRangeAttack2(float flDot, float flDist)
{
...
//=========================================================
void CHGruntAllyMedic::TraceAttack(entvars_t* pevAttacker, float flDamage, Vector vecDir, TraceResult* ptr, int bitsDamageType)
{
...
//=========================================================
int CHGruntAllyMedic::TakeDamage(entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType)
{
...
//=========================================================
void CHGruntAllyMedic::SetYawSpeed()
{
	switch (m_Activity)
	{
		case ACT_IDLE:
...
// IdleSound
//=========================================================
void CHGruntAllyMedic::IdleSound()
{
...
//=========================================================
void CHGruntAllyMedic::CheckAmmo()
{
	if (m_cAmmoLoaded <= 0)
	{
...
// Kick
//=========================================================
CBaseEntity* CHGruntAllyMedic::Kick()
{
	TraceResult tr;
...
Vector CHGruntAllyMedic::GetGunPosition()
{
	if (m_fStanding)
...
//=========================================================
void CHGruntAllyMedic::HandleAnimEvent(MonsterEvent_t* pEvent)
{
	Vector	vecShootDir;
...
void CHGruntAllyMedic::Spawn()
{
	...
	CAllyMonster::g_talkWaitTime = 0;

	MonsterInit();

	SetUse(&CHGruntAllyMedic::HealerUse);
}

//=========================================================
// Precache - precaches all resources this monster needs
//=========================================================
void CHGruntAllyMedic::Precache()
{
	if (pev->model)
...
// start task
//=========================================================
void CHGruntAllyMedic::StartTask(Task_t* pTask)
{
	...
	{
		if (!m_fHealing)
			return CSquadTalkMonster::StartTask(pTask);
...
// RunTask
//=========================================================
void CHGruntAllyMedic::RunTask(Task_t* pTask)
{
	switch (pTask->iTask)
	{
	case TASK_MEDIC_ALLY_FACE_TOSS_DIR:
...
// PainSound
//=========================================================
void CHGruntAllyMedic::PainSound()
{
...
// DeathSound 
//=========================================================
void CHGruntAllyMedic::DeathSound()
{
...
DEFINE_CUSTOM_SCHEDULES(CHGruntAllyMedic)
{
	slGruntFail,
	slGruntCombatFail,
	slGruntVictoryDance,
...
IMPLEMENT_CUSTOM_SCHEDULES(CHGruntAllyMedic, CSquadTalkMonster);

//=========================================================
// SetActivity 
//=========================================================
void CHGruntAllyMedic::SetActivity(Activity NewActivity)
{
...
// Get Schedule!
//=========================================================
Schedule_t* CHGruntAllyMedic::GetSchedule()
{
	// clear old sentence
	m_iSentence = MEDIC_SENT_NONE;
...
//=========================================================
//=========================================================
Schedule_t* CHGruntAllyMedic::GetScheduleOfType(int Type)
{
	switch (Type)
	{
...
void CHGruntAllyMedic::TalkInit()
{
...
void CHGruntAllyMedic::AlertSound()
{
...
void CHGruntAllyMedic::DeclineFollowing()
{
	PlaySentence("FG_POK", 2, VOL_NORM, ATTN_NORM);
}

void CHGruntAllyMedic::KeyValue(KeyValueData* pkvd)
{
...
void CHGruntAllyMedic::Killed(entvars_t* pevAttacker, int iGib)
{
...
void CHGruntAllyMedic::MonsterThink()
{
...
BOOL CHGruntAllyMedic::HealMe(CSquadTalkMonster* pTarget)
{
	if (pTarget)
	{
		if (m_hTargetEnt && !m_hTargetEnt->IsPlayer())
...
void CHGruntAllyMedic::HealerActivate(CBaseMonster* pTarget)
{
	if (m_hTargetEnt)
	{
...
void CHGruntAllyMedic::HealerUse(CBaseEntity* pActivator, CBaseEntity* pCaller, USE_TYPE useType, float value)
{
