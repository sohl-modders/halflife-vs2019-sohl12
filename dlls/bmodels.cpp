...
public:
	...
	USE_STATE GetState(void) override { return pev->frame ? STATE_ON : STATE_OFF; };
...
public:
	...
	void TurnOn(void);
	BOOL IsOn(void);
	USE_STATE GetState(void) override { return (pev->solid == SOLID_NOT) ? STATE_OFF : STATE_ON; };
};
...
public:
	...
	USE_STATE GetState(void) override { return m_iState; }; //LRC
};
...
public:
	...
	int Restore(CRestore& restore) override;
	void Blocked(CBaseEntity* pOther) override;
	USE_STATE GetState(void) override { return (pev->speed) ? STATE_ON : STATE_OFF; }
